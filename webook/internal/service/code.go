...
type ChinaCodeService struct {
	repo repository.CodeRepository
	sms  sms.Service
}

func NewCodeService(repo repository.CodeRepository, smsSvc sms.Service) CodeService {
	return &ChinaCodeService{
		repo: repo,
		sms:  smsSvc,
	}
}

func (svc *ChinaCodeService) Send(ctx context.Context, biz, phone string) error {
	code := svc.generate()
...
func (svc *ChinaCodeService) Verify(ctx context.Context,
...
func (svc *ChinaCodeService) generate() string {
	// 0-999999
